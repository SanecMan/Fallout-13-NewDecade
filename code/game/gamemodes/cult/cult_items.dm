...
/obj/item/weapon/reagent_containers/food/drinks/bottle/unholywater
	name = "сосуд с несвятой водой"
	desc = "Токсична для неверующих; Ей можно напоить или метнуль в кого-то."
	eng_name = "flask of unholy water"
	eng_desc = "Toxic to nonbelievers; reinvigorating to the faithful - this flask may be sipped or thrown."
