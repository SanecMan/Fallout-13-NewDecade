...
/obj/structure/barricade_m
	...
	var/flags_atom = ON_BORDER
	var/climb_delay = 20 //Leaping a barricade is universally much faster than clumsily climbing on a table or rack
...
/obj/structure/barricade_m/New()
	..()
	spawn(0)
		update_icon()

/obj/structure/barricade_m/examine(mob/user)
	..()
...
/obj/structure/barricade_m/hitby(atom/movable/AM)
...
/obj/structure/barricade_m/CheckExit(atom/movable/O, turf/target)
	if(closed)
		return TRUE
...
/obj/structure/barricade_m/CanPass(atom/movable/mover, turf/target)
	if(closed)
		return TRUE
	...
	//var/obj/structure/S/flags_atom
...
/obj/structure/barricade_m/attack_robot(mob/user as mob)
	return attack_hand(user)

/obj/structure/barricade_m/attack_animal(mob/user as mob)
...
/obj/structure/barricade_m/attackby(obj/item/W, mob/user)
...
/*proc/obj/structure/barricade/destroy(deconstruct)
	...
	qdel(src)
*/
/obj/structure/barricade_m/ex_act(severity)
	switch(severity)
		if(1.0)
...
/obj/structure/barricade_m/update_icon()
	if(!closed)
...
/obj/structure/barricade_m/proc/update_overlay()
	if(!is_wired)
		return
...
/obj/structure/barricade_m/proc/hit_barricade(obj/item/I)
	/*if(istype(I, /obj/item/weapon/zombie_claws))
		health -= I.force * 0.5*/
	health -= I.force * 0.5
	update_health()

/obj/structure/barricade_m/proc/update_health(nomessage)
...
/obj/structure/barricade_m/proc/update_damage_state()
...
/obj/structure/barricade_m/proc/acid_smoke_damage(var/obj/effect/particle_effect/smoke/S)
	health -= 15
	update_health()

/obj/structure/barricade_m/verb/rotate()
...
/obj/structure/barricade_m/verb/revrotate()
...
/obj/structure/barricade_m/wooden
...
/obj/structure/barricade_m/wooden/attackby(obj/item/W as obj, mob/user as mob)
	/*for(var/obj/effect/xenomorph/acid/A in src.loc)
		if(A.acid_t == src)
			to_chat(user, "You can't get near that, it's melting!")
			return*/
...
/obj/structure/barricade_m/wooden/hit_barricade(obj/item/I)
	switch(I.damtype)
		if("fire")
			health -= I.force * 1.5
		if("brute")
...
/obj/structure/barricade_m/wooden/bullet_act(var/obj/item/projectile/P)
	//bullet_ping(P)
	health -= round(P.damage/2) //Not that durable.
...
/obj/structure/barricade_m/metal
...
/obj/structure/barricade_m/metal/examine(mob/user)
	..()
	switch(build_state)
		if(2)
...
/obj/structure/barricade_m/metal/attackby(obj/item/W, mob/user)
...
/obj/structure/barricade_m/sandbags
...
/obj/structure/barricade_m/sandbags/attackby(obj/item/W, mob/user)
	...
	if(istype(W, /obj/item/weapon/shovel) && user.a_intent != "hurt")
		//var/obj/item/tool/shovel/ET = W
		//if(!ET.folded)
...
/obj/structure/barricade_m/sandbags/bullet_act(obj/item/projectile/P)
	//bullet_ping(P)
	health -= round(P.damage/10)
