...
/obj/effect/mob_spawn/human/prisoner_transport/New()
	...
	to lose this opportunity. Find_char a way to get out of this mess and back to where you rightfully belong - your [pick("house", "apartment", "spaceship", "station")]</b>."
	..()
