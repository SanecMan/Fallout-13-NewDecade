...
*/
	...
	//Watchlist
		...
		while (findtext(src.admincaster_feed_channel.channel_name," ") == 1)
			src.admincaster_feed_channel.channel_name = copytext(src.admincaster_feed_channel.channel_name,2,length_char(src.admincaster_feed_channel.channel_name)+1)
		src.access_news_network()
		...
		while (findtext(src.admincaster_feed_message.returnBody(-1)," ") == 1)
			src.admincaster_feed_message.body = copytext(src.admincaster_feed_message.returnBody(-1),2,length_char(src.admincaster_feed_message.returnBody(-1))+1)
		src.access_news_network()
		...
		while(findtext(src.admincaster_wanted_message.criminal," ") == 1)
			src.admincaster_wanted_message.criminal = copytext(admincaster_wanted_message.criminal,2,length_char(admincaster_wanted_message.criminal)+1)
		src.access_news_network()
		...
		while (findtext(src.admincaster_wanted_message.body," ") == 1)
			src.admincaster_wanted_message.body = copytext(src.admincaster_wanted_message.body,2,length_char(src.admincaster_wanted_message.body)+1)
		src.access_news_network()
