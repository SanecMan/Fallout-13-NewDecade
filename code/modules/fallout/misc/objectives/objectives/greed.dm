...
/datum/f13_objective/greed
	name = "Скрудж"
	desc = "Вы жили в бедности, перебирались напомойках а ваши родные умерли от голода, вы решили прервать черту бедности вашего рода.<br>Наберите %count% крышек, чтобы наконец выбраться из долгов."
	kind = INDIVIDUAL
