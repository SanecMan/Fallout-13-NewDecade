...
/mob/living/carbon/human/proc/karmaText()
	var/list/text = list (
		...
		"<font color='#bf0000'>Кажется, что вот-вот выпотрошит вас.</font>",
		"<font color='#676767'>Ничего примечательного.</font>",
		"<font color='#009200'>Выглядит доброжелательно.</font>",
		"<font color='#486d00'>Вы верите, что может изменить мир к лучшему.</font>"
	)
